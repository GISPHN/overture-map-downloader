...
- POIへの次の列の追加
  - `施設名`
  - `生活機能区分`、`生活機能詳細コード`、`生活機能詳細区分`
  - `食料品アクセス区分コード`、`食料品アクセス区分`、`食料品分類根拠`
  - `調剤サブ施設フラグ`
  - `ドラッグストアチェーン`、`スーパーマーケットチェーン`
  - Overtureの新`taxonomy`、`basic_category`
...
食料品以外の生活機能は、新taxonomyの階層を使って病院、診療所、歯科、調剤薬局、高齢者施設、地域支援、ATM、銀行、郵便局、行政機関、鉄道、バス、タクシー、公園、運動施設、図書館、博物館、文化施設、日常生活サービスなどに分けます。QGISでは`生活機能詳細区分`をカテゴリ値に指定すると機能別に色分けできます。
